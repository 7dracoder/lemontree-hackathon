        ...
        <div className="bg-card border border-border p-5">
          ...
          <ResponsiveContainer width="100%" height={180}>
            <BarChart data={ratingDist}>
              <XAxis dataKey="stars" tick={{ fill: '#71717A', fontSize: 10, fontFamily: 'JetBrains Mono' }} axisLine={false} tickLine={false} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-card border border-border">
          <div className="p-4 border-b border-border flex items-center justify-between bg-page">
            ...
            <span className="text-[10px] tracking-widest font-bold uppercase text-tertiary">
